(function() {
  var CHAT_ENDPOINT = 'https://n8n.stromation.com/webhook/bidengine-chat';
  var history = [];
  var isOpen = false;
  var isLoading = false;
  ...
  widget.innerHTML =
    ...
    '#be-toggle{position:fixed;bottom:20px;left:20px;z-index:998;width:56px;height:56px;border-radius:50%;background:#E8650A;color:#0A1220;border:none;cursor:pointer;box-shadow:0 4px 15px rgba(232,101,10,0.4);display:flex;align-items:center;justify-content:center;transition:all 0.3s;}' +
    '#be-toggle:hover{transform:scale(1.08);box-shadow:0 6px 25px rgba(232,101,10,0.5);}' +
    '#be-toggle.active{background:#0A1220;color:#E8650A;border:2px solid #E8650A;}' +
    ...
    '#be-header .icon{width:32px;height:32px;background:#E8650A;border-radius:8px;display:flex;align-items:center;justify-content:center;font-weight:900;color:#0A1220;font-size:14px;}' +
    ...
    '.be-user{background:#E8650A;color:#0A1220;align-self:flex-end;border-bottom-right-radius:4px;font-weight:500;}' +
    ...
    '#be-input:focus{border-color:#E8650A;}' +
    '#be-send{background:#E8650A;color:#0A1220;border:none;border-radius:10px;padding:10px 14px;cursor:pointer;font-weight:700;transition:background 0.2s;}' +
    '#be-send:hover{background:#C4520A;}' +
